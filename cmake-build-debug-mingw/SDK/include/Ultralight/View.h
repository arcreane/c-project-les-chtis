...
class UExport View : public RefCounted {
 public:
  ...
  ///
  /// @note  Only valid when the CPU is enabled (will return a nullptr otherwise)
  ///
  ...
  ///
  /// Get the inspector for this View, this is useful for debugging and inspecting pages locally.
  ...
  ///
  /// @note  The inspector View is owned by the View and lazily-created on first call. The initial
  ///        dimensions are 10x10, you should call View::Resize() on the returned View to resize it
